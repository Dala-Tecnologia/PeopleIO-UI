...
1. **FormularioCandadito** (main form component) orchestrates three sub-forms via `react-hook-form` + `zod` validation
...
4. **Backend Integration** posts complete payload to `https://peopleio-api-dev.azurewebsites.net/api/v1/candidatos`
