  ...
  return (
    <>
      ...
      <div className="flex justify-between items-center mb-4">
        <Link to="/candidato/novo" className="pio-btn-primary">Novo candidato</Link>
            ...
            {filteredItems.map((candidato) => (
              <tr key={candidato.id} className="bg-white border-b dark:bg-gray-800/50 dark:border-gray-600 hover:bg-gray-50 dark:hover:bg-gray-600">
                ...
                <td className="px-6 py-4 flex gap-4">
                  <Link to={`/candidato/${candidato.id}`} className="font-medium text-blue-600 dark:text-blue-500 hover:underline">Editar</Link>
